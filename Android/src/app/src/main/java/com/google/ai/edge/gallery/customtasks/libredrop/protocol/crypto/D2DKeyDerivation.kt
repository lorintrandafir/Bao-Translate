 ...
 *
 * ```
 * # Stage 1 — UKEY2 layer (inputs come from [com.google.ai.edge.gallery.customtasks.libredrop.protocol.ukey2.Ukey2HandshakeResult])
...
public object D2DKeyDerivation {
     ...
     *
     * The companion test [com.google.ai.edge.gallery.customtasks.libredrop.protocol.crypto.D2DKeyDerivationTest]
