 ...
 *    [com.google.ai.edge.gallery.customtasks.libredrop.protocol.server.InboundConnectionCompletion.connectionId]).
 *
...
public object ConsentIntents {
    ...
    public const val ACTION_ACCEPT: String = "com.google.ai.edge.gallery.customtasks.libredrop.consent.ACCEPT"

    /** Broadcast action fired when the user taps the notification's "Reject" action. */
    public const val ACTION_REJECT: String = "com.google.ai.edge.gallery.customtasks.libredrop.consent.REJECT"
     ...
     * [com.google.ai.edge.gallery.customtasks.libredrop.protocol.connection.InboundConnection.cancel]
     * rather than `submitUserConsent`.
     */
    public const val ACTION_CANCEL_TRANSFER: String = "com.google.ai.edge.gallery.customtasks.libredrop.consent.CANCEL_TRANSFER"
     ...
     */
    public const val ACTION_SHOW_CONSENT: String = "com.google.ai.edge.gallery.customtasks.libredrop.consent.SHOW"
