 ...
 *    ([com.google.ai.edge.gallery.customtasks.libredrop.protocol.payload.PayloadTransferEncoder.encodeBytesPayload])
...
public sealed interface SharingFsmEffect {
     ...
     *     we; reuse causes the receiver's [com.google.ai.edge.gallery.customtasks.libredrop.protocol.payload.PayloadAssembler]
     *     to reject the frame).
     *  2. Calling [com.google.ai.edge.gallery.customtasks.libredrop.protocol.payload.PayloadTransferEncoder.encodeBytesPayload]
