...
import com.google.ai.edge.gallery.customtasks.libredrop.protocol.sharing.IntroductionFrame
 ...
 * enters [com.google.ai.edge.gallery.customtasks.libredrop.protocol.sharing.InboundSharingState.WaitingForUserConsent].
 ...
 *   `authString` via [com.google.ai.edge.gallery.customtasks.libredrop.protocol.crypto.pin.PinDerivation.deriveFourDigitPin].
...
public data class TransferMetadata(
    ...
    public companion object {
         ...
         *   [com.google.ai.edge.gallery.customtasks.libredrop.protocol.sharing.SharingFsmEffect.IntroductionReceived].
